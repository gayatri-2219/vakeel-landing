            ...
            <div className="flex-1 min-w-0">
              ...
              <motion.div {...fadeUp(0.24)} className="flex flex-col sm:flex-row items-start gap-4">
                ...
                <div className="relative group">
                  <button className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 border border-white/20 text-white rounded-xl font-semibold text-base hover:bg-white/15 transition-all">
                  ...
                  <div className="absolute left-0 top-full mt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-left translate-y-2 group-hover:translate-y-0 bg-white border border-border/50 rounded-xl shadow-xl overflow-hidden z-50">
                    <a href="/VAKEEL-Mac.dmg" download="VAKEEL-1.0.0-arm64.dmg" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-foreground hover:bg-muted transition-colors">
                    ...
                    <span className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-muted-foreground/50 border-t border-border/50 cursor-not-allowed select-none">
                      ...
                      <span className="ml-auto text-[10px] font-mono bg-muted px-1.5 py-0.5 rounded text-muted-foreground">Soon</span>
                    </span>
                    <a href="https://github.com/gayatri-2219/vakeel-1" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-foreground hover:bg-muted transition-colors border-t border-border/50">
